...
public class PostOffice {
     ...
     */
    public PostOffice() {
		System.out.println("Using new POST OFFICE");
	...
	*/
	...
	while (true) {
	    ...
	    // Atomically add message to the TransportReliability received messages queue, so the receiveTask can consume it
	    TransportReliability.recvdMessages.add(mail);
	}
    }
